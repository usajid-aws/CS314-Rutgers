...
(define (repeat-rows nrepeat figure)
  (make-figure (lambda (row col) ((figure-func figure) (modulo row (figure-numrows figure)) col)) 
...
(define (append-cols figurea figureb)
  (make-figure (lambda (row col) (if (< col (figure-numcols figurea)) 
                        ((figure-func figurea) row col)
                        ((figure-func figureb) row (- col (figure-numcols figurea)))))
               (min (figure-numrows figurea) (figure-numrows figureb))
...
(define (append-rows figurea figureb)
  (make-figure (lambda (row col) (if (< row (figure-numrows figurea))
                        ((figure-func figurea) row col)
                        ((figure-func figureb) (- row (figure-numrows figurea) col))))
                (+ (figure-numrows figurea) (figure-numrows figureb))
                (min (figure-numcols figurea) (figure-numcols figureb)))
  )
